...
class MainFragment : Fragment() {
    ...
    fun loadData(){
        listSerial.add(
            SerialModel(
                img = "https://i.pinimg.com/236x/84/a6/e0/84a6e0b28c3ef9ad78e28cfac6651533.jpg?nii=t",
                name = "Chenobyl", episode = "S1.E5", date = "2019"
            )
        )
        listSerial.add(
            SerialModel(
                img = "https://upload.wikimedia.org/wikipedia/en/5/51/Rise_of_empires_ottoman.jpg",
                name = "Chenobyl", episode = "S1.E5", date = "2033"
            )
        )
        listSerial.add(
            SerialModel(
                img = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRVukqQMfCvC_YS4BfiIv__jpHb9J2zUvaRdA&s",
                name = "Chenobyl", episode = "S1.E5", date = "2019"
            )
        )
        listSerial.add(
